...
public extension String {
	...
	public var camelCased: String {
		...
		let first = source.substring(to: source.index(after: source.startIndex)).uppercased()
		let rest = String(source.characters.dropFirst())
		guard source.characters.contains(" ") || source.characters.contains("\n") else {
			return first + rest
		}
		let camel = source.capitalized
			.replacingOccurrences(of: " ", with: "")
			.replacingOccurrences(of: "\n", with: "")
		
		let restCamel = String(camel.characters.dropFirst())
		return first + restCamel
	}
	...
	public var mostCommonCharacter: Character {
		let withoutSpacesAndNewLines = replacingOccurrences(of: " ", with: "").replacingOccurrences(of: "\n", with: "")
		var dict: [Character: Int] = [:]
		
		for character in characters {
			guard let key = dict[character] else {
				dict[character] = 1
			}
			dict[character]! += 1
		}
...
public extension String {
	...
	public subscript(safe i: Int) -> String? {
		...
		return self.substring(with: index(startIndex, offsetBy: i))
	}
	
	/// SwifterSwift: Safely subscript string within a half-open range.
	///
	/// - Parameter range: Half-open range.
	public subscript(range: CountableRange<_>) -> String? {
		...
		return String(self[safe: lowerIndex..<upperIndex])
	}
	...
	public mutating func truncate(toLength: Int, trailing: String? = "...") {
		...
		if characters.count > toLength {
			self = String(characters.prefix(toLength)) + (trailing ?? "")
		}
	}
	...
	public func truncated(toLength: Int, trailing: String? = "...") -> String {
		...
		return String(characters.prefix(toLength)) + (trailing ?? "")
	}
...
public extension String {
	...
	@available(*, deprecated: 4.0, message: "Use characters instead", renamed: "characters")
	/// SwifterSwift: Array of characters of a string.
	public var charactersArray: [Character] {
		return Array(characters)
	}
	
	@available(*, deprecated: 4.0, message: "Use characters.first instead", renamed: "characters.first")
	...
	@available(*, deprecated: 4.0, message: "Use characters.last instead", renamed: "characters.last")
	...
	@available(*, deprecated: 4.0, renamed: "reversedString")
	/// SwifterSwift: Reversed string.
	public var reversed: String {
		return String(characters.reversed())
	}
	
	@available(*, deprecated: 4.0, message: "Use Float32(self) instead")
	...
	@available(*, deprecated: 4.0, message: "Use Float64(self) instead")
	...
	@available(*, deprecated: 4.0, message: "Use Int16(self) instead")
	/// SwifterSwift: Int16 value from string (if applicable).
	public var int16: Int16? {
		return Int16(self)
	}
	
	@available(*, deprecated: 4.0, message: "Use Int32(self) instead")
	/// SwifterSwift: Int32 value from string (if applicable).
	public var int32: Int32? {
		return Int32(self)
	}
	
	@available(*, deprecated: 4.0, message: "Use Int64(self) instead")
	/// SwifterSwift: Int64 value from string (if applicable).
	public var int64: Int64? {
		return Int64(self)
	}
	
	@available(*, deprecated: 4.0, message: "Use Int8(self) instead")
	/// SwifterSwift: Int8 value from string (if applicable).
	public var int8: Int8? {
		return Int8(self)
	}
	
	@available(*, deprecated: 4.0,message: "Use replacingOccurrences(of: substring, with: newString) instead")
